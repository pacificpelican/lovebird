...
const CODEIGNITER_SYSTEM_VERSION = '3.0.6';		//	codeigniter.com
...
define('DJM_DB_NAME', 'lovebird4');	//	development (local) site database name
...
define('SITE_NAME', 'LoveBird');		//	Site name, can be URL w/o https:// or whatever the site is called
